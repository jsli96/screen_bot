...
def run_app(array_1, array_2, array_3):
    ...
    img_template = cv.imread("photo/evaluation_template_3.png", cv.IMREAD_GRAYSCALE)  # Read template image
    img_template = cv.resize(img_template, (0, 0), fx=0.25, fy=0.25)
    ...
    if p1 is not None and p2 is not None and p3 is not None:
        ...
        d_1, a_1 = get_angle_length(center, [266.5, 200], p1)
